...
(function ($, document, window, undefined) {
    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
		...
		/**
        * Adds or remove the possiblity of scrolling through sections by using the touch gestures.
        */
        PP.setAllowTouch = function (value){
            if(value){
                addTouchHandler();
            }else{
                removeTouchHandler();
        ...
        */
        function removeMouseWheelHandler(){
            if (container.get(0).addEventListener) {
                container.get(0).removeEventListener('mousewheel', MouseWheelHandler, passiveSupported ? { passive: true } : false); //IE9, Chrome, Safari, Oper
                container.get(0).removeEventListener('wheel', MouseWheelHandler, passiveSupported ? { passive: true } : false); //Firefox
            } else {
        ...
        */
        function addMouseWheelHandler(){
            if (container.length) {
                if (container.get(0).addEventListener) {
                    container.get(0).addEventListener('mousewheel', MouseWheelHandler, passiveSupported ? { passive: true } : false); //IE9, Chrome, Safari, Oper
                    container.get(0).addEventListener('wheel', MouseWheelHandler, passiveSupported ? { passive: true } : false); //Firefox
                } else {
